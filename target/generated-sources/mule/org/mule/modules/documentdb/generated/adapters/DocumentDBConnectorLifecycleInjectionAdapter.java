...
/**
 * A <code>DocumentDBConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link DocumentDBConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2016-12-04T01:15:06+01:00", comments = "Build UNNAMED.2793.f49b6c7")
public class DocumentDBConnectorLifecycleInjectionAdapter
    extends DocumentDBConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(DocumentDBConnectorLifecycleInjectionAdapter.class);
