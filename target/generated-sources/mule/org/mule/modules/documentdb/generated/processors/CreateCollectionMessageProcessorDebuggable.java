...
public class CreateCollectionMessageProcessorDebuggable
    extends CreateCollectionMessageProcessor
    implements DebugInfoProvider
{


    public CreateCollectionMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("collectionID", "Collection ID", (java.lang.String.class), collectionID, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("databaseID", "Database ID", (java.lang.String.class), databaseID, muleEvent));
