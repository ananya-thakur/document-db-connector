...
/**
 * CreateCollectionMessageProcessor invokes the {@link org.mule.modules.documentdb.DocumentDBConnector#createCollection(java.lang.String, java.lang.String)} method in {@link DocumentDBConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedDatabaseID = ((String) evaluateAndTransform(getMuleContext(), event, CreateCollectionMessageProcessor.class.getDeclaredField("_databaseIDType").getGenericType(), null, databaseID));
            final String _transformedCollectionID = ((String) evaluateAndTransform(getMuleContext(), event, CreateCollectionMessageProcessor.class.getDeclaredField("_collectionIDType").getGenericType(), null, collectionID));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((DocumentDBConnector) object).createCollection(_transformedDatabaseID, _transformedCollectionID);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at DocumentDBConnector at createCollection retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
